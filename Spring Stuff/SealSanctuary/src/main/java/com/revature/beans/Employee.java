...
public class Employee {
	...
	public Employee(int e_ID, String lOGIN, String pASS, String fIRSTNAME, String lASTNAME, String eMAIL, String pHONE,
	...
	public String toString() {
		return "Employee [E_ID=" + E_ID + ", LOGIN=" + LOGIN + ", PASS=" + PASS + ", FIRSTNAME=" + FIRSTNAME
				+ ", LASTNAME=" + LASTNAME + ", EMAIL=" + EMAIL + ", PHONE=" + PHONE + ", ADDRESS=" + ADDRESS
				+ ", SUPERVISOR=" + SUPERVISOR + ", REPORTSTO=" + REPORTSTO + "]";
	}
